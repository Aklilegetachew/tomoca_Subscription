...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 displayBig">
        ...
        <div class="card-body">
            <div class="table-responsive" id="TableDelivery">
                <table class="table table-bordered" id="dataTableDeli" width="100%" cellspacing="0">
                    <thead>
                        <tr>
...
<div id="TableDeliveryMini">
    <div v-if="newRowMini !== ''">
        <div v-for="row in newRowMini" class="CustomCard">
            <div class="card border-left-primary shadow h-200">

                <button @click="convertNew(row.ID,'Del')" class="CustomCard dropdown-item d-flex">
    ...
    <div class="Nodata">
        <h6 v-if=" newRowMini==''" class="m-0 font-weight-bold text-primary">
