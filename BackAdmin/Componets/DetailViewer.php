...
$FullName = $detail['sub_name'];
$PhoneNumber = $detail['sub_phone'];
$TotalPayment = $detail['payment_Total'];
$Status = $detail['payment_status'];
$NextDate = $detail['next_orderDate'];

$TransactionNumber = $detail['transaction_number'];
$TinNumber = $detail['tin_num'];
$BussinessName = $detail['tin_name'];
